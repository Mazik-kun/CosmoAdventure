...
if(langstate == 2){
    ...
    ansans = [
        ...
        "Лично я, вот лично, я с вами согласен, но все вот эти вот учёные они так не думают. Знаете как у нас в секторе 7210 говорят про таких учёных? А вот надо бы знать",
